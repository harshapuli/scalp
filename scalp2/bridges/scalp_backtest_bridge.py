...
# Resolve scalp 1 root by climbing two levels then over to scalp_backtest/
# /claude/gemini /scalp2/bridges/scalp_backtest_bridge.py → /claude/gemini /scalp_backtest/
